<template>
  <div class="login">
    ...
    <div class="el-login-footer">
      <span>Copyright © 2013-2025 <a href="http://www.python222.com" target="_blank">scmcc.com.cn</a> 版权所有.</span>
    </div>
  </div>
</template>
    ...
    if (valid) {
      ...
      if (data.code == 200) {
        ...
        if (loginForm.value.rememberMe) {
          ...
          Cookie.set('rememberMe', loginForm.value.rememberMe, {expires: 30});
        } else {
